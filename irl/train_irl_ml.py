...
import utils
import models
from policy import MLIRLPolicy
...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument("--expert-path", type=str)
...
def main(args: argparse.Namespace = get_args()):
    ...
    reward_optim = torch.optim.Adam(reward_model.parameters(), lr=args.reward_lr)

    # Expert replay buffer

    expert_buffer = ts.data.ReplayBuffer.load_hdf5(args.expert_path)

    print("Expert buffer size:", len(expert_buffer))
